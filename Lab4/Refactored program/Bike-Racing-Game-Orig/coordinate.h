...
class cord          //Holds the coordinates of the images
{
     ...
     int get_cord_x()              //Returns the current x coordinate of the object...
     {
          return cord_rect.x;
     }
     int get_cord_y()              //Returns the current y coordinate of the object...
     {
          return cord_rect.y;
     }
     int get_cord_w()
