...
//			}
//		multiply_m(add_matrix(a00, a11), add_matrix(b00, b11), &m1);
//		multiply_m(add_matrix(a10, a11), b00, &m2);
//		multiply_m(a00, subtr_matrix(b01, b11), &m3);
//		multiply_m(a11, subtr_matrix(b10, b00), &m4);
//		multiply_m(add_matrix(a00, a01), b11, &m5);
//		multiply_m(subtr_matrix(a10, a00), add_matrix(b00, b01), &m6);
//		multiply_m(subtr_matrix(a01, a11), add_matrix(b10, b11), &m7);
//
